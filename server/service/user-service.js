...
class UserService {
    async registration(email, password, name, surname, patronymic, gender){
        ...
        const user = await UserModel.create({email, password: hashPassword, name, surname, patronymic, activationLink, gender})
